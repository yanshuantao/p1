...
public class PaginationInfo {
	 ...
	 * 李大海 添加
	 */
	public PaginationInfo(List<String> sysCodeList) {
	...
	public PaginationInfo(Boolean isCheckPageNo) {
	...
	public int getPageSize() {
		if (pageSize < 0 && params.get("pageSize") == null) {
			pageSize = 15;
		} else {
	...
	public PaginationInfo addParam(String K, Object V) {
